...
import io.arcblock.walletkit.solana.crypto.Hash;
import io.arcblock.walletkit.solana.crypto.HdUtil;
import io.arcblock.walletkit.solana.crypto.HmacSha512;
import io.arcblock.walletkit.solana.crypto.Secp256k1;
...
public class HdKeyGenerator {
  ...
  public HdAddress getAddress(HdAddress parent, long child, boolean isHardened) {
    ...
    if (isHardened) {
      ...
      System.out.println(
          "solana isHardened key data " + originChild + " " + BaseEncoding.base16().encode(kpar.toByteArray()));
      byte[] data = HdUtil.append(new byte[] { 0 }, HdUtil.ser256(kpar));
      data = HdUtil.append(data, HdUtil.ser32(child));
      System.out.println(
          "solana isHardened data " + originChild + " " + BaseEncoding.base16().encode(data));
      System.out.println(
          "solana isHardened chain " + originChild + " " + BaseEncoding.base16().encode(xChain));
    ...
    System.out.println("solana " + originChild + " " + BaseEncoding.base16().encode(I));
    ...
    System.out.println("solana childSecretKey " + originChild + " " + BaseEncoding.base16().encode(HdUtil.append(new byte[] { 0 }, HdUtil.ser256(childSecretKey))));
    System.out.println("solana ChainCode " + originChild + " " + BaseEncoding.base16().encode(IR));
    ...
    privateKey.setPrivateKey(IL);
    //privateKey.setPrivateKey(HdUtil.ser256(childSecretKey));
