...
//    )
    ...
    Assert.assertEquals(
      "0x0021E4B8F62674897ED75DF0F7356E82C6F9A64A5C13F3CC0CD3",
      IdGenerator.sk2did(
        BaseEncoding.base16()
          .decode(sk),
  ...
  fun seedToDid() {
    ...
    val kp = IdGenerator.genAppKeyPair(
      "did:abt:zZeZVr12oY4hEevye8yo8BbRE75CuWBogHYNVbaceKkCw5wUYuNissZx3JgGk",
      0,
      seed,
      ED25519
    )
  ...
  fun isFromPublicKey(){
    ...
    val pk = "z3DmL11f5TiTNmRDVCSMdsoPYWdM8N5b9rf8K3fi9sQuHnX84yBpfxj4B8m7VTcAeiRqWBLSwAyvruZiNxZqLaGyt".decodeB58()
    val result = DidUtils.isFromPublicKey(address, pk)
    assert(result)

    val address2 = "0x39875F135Ddca2e18e3d1679bCa6059198b00aA2"
    val pk2 = "z3vgraBB9AfCjCexFWY8oztu6rdu3Wa9gpVQxJVzoLLo35FZaD9RkBcSp958iqxpFugiVcWeFe6Jf9U8p8GAh3gpT".decodeB58()
  ...
  fun testGenDelegateAddress() {
    val address = IdGenerator.genDelegateAddress(
      ...
      "z1T6maYajgDLjhVErT71WEbqaxaWHs9nqpZ"
    )
